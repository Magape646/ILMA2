                                ...
                                <div class="col-md-6 col-sm-6">
                                    <a  >
                                        <div class="article-thumb">
                                            <img src="/storage/img/education/honours_images/{{ $honour->cover_image}}" class="img-responsive" alt=""/>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-md-6 col-sm-6">
