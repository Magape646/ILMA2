    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                @if (count($doctrates) > 0)

                @foreach ($doctrates as $doctrate)
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <a  >
                                        <div class="article-thumb">
                                            <img src="/storage/img/education/doctrates_images/{{ $doctrate->cover_image}}" class="img-responsive" alt=""/>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-md-6 col-sm-6">
