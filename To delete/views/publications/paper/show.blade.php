                ...
                <article class="style3 single text-center">
                        ...
                        <div class="post-thumb">
                            ...
                            <div class="post-excerpt">
                                ...
                                <h3 class="h1 text-white">{{ $publicationpaper->title }}</h3>
                                <div class="meta">
                                    <span>{{ $publicationpaper->updated_at }}</span>
                                </div>
                                <div class="meta">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="post-nav ">
                    <a href="/publicationpapers" class="btn btn-primary ">Back</a>
                </div>
