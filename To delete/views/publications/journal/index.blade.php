    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                @if (count($publicationjournals) > 0)

                @foreach ($publicationjournals as $publicationjournal)

                <article>

                    <div class="post-excerpt">
                        <div class="small-title cat">{{ $publicationjournal->updated_at }}</div>
                        <h3><a >{{ $publicationjournal->title }}</a></h3>
                        <div class="meta">
                            <span>{{ $publicationjournal->authors }}</span>
                        </div>
                        <div class="meta">
                            <span><strong>{{ $publicationjournal->journal }}</strong> {{ $publicationjournal->journalpages }}</span>
                        </div>
                        <br>


                        <a href="/publicationjournals/{{ $publicationjournal->id }}" class="btn btn-primary">Abstract</a>
                        <a href="/storage/img/journal_documents/{{ $publicationjournal->cover_image}}" class="btn btn-success">Download</a>
                    </div>
                </article>
