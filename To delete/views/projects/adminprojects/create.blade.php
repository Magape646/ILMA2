   ...
   <div class="panel panel-inverse" data-sortable-id="form-stuff-9">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('pdftitle', '',['class'=>'form-control', 'placeholder' => 'Pdftitle']) }}
        </div>

        <div class="form-group">
            {{ Form::label('pdfauthor','Pdfauthor') }}
            {{ Form::text('pdfauthor', '',['class'=>'form-control', 'placeholder' => 'Pdfauthor']) }}
        </div>

        <div class="form-group">
            {{ Form::label('pdfdate','Pdfdate') }}
            {{ Form::text('pdfdate', '',['class'=>'form-control', 'placeholder' => 'Pdfdate']) }}
        </div>

        <div class="form-group">
            {{ Form::label('linkstitle','Linkstitle') }}
            {{ Form::text('linkstitle', '',['class'=>'form-control', 'placeholder' => 'Linkstitle']) }}
        </div>

        <div class="form-group">
            {{ Form::label('linksurl','Linksurl') }}
            {{ Form::text('linksurl', '',['class'=>'form-control', 'placeholder' => 'Linksurl']) }}
        </div>
